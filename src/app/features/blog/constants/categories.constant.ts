...
export const CATEGORIA: CategoriaPostModel[] = [
    {
        ...
        posicion: 'rot-2',
        abertura: '80%',
        rutaIcono: 'assets/img/categorias/ia-white.png',
        alturaIcono: '100',
        estado:'activo',
        glosario: [],
        ruta: 'blog/ai',
    ...
    },
    {
        ...
        posicion: 'pos-z',
        abertura: '80%',
        rutaIcono: 'assets/img/categorias/css-white.png',
        alturaIcono: '80',
        estado: 'activo',
        glosario: [],
        ruta: 'css',
    ...
    },
    {
        ...
        posicion: 'rot-2',
        abertura: '',
        rutaIcono: 'assets/img/categorias/dart-white.png',
        alturaIcono: '80',
        estado: 'inactivo',
        glosario: [],
        ruta: 'dart',
    ...
    },
    {
        ...
        posicion: 'pos-z',
        abertura: '',
        rutaIcono: 'assets/img/categorias/electron-white.png',
        alturaIcono: '90',
        estado: 'inactivo',
        ruta: 'electron',
        glosario: [],
    ...
    },
    {
        ...
        posicion: 'rot-1',
        abertura: '',
        rutaIcono: 'assets/img/categorias/flutter-white.png',
        alturaIcono: '80',
        estado: 'inactivo',
        glosario: [],
        ruta: 'flutter',
    ...
    },
    {
        ...
        posicion: 'rot-3',
        abertura: '',
        rutaIcono: 'assets/img/categorias/git-white.png',
        alturaIcono: '80',
        estado: 'inactivo',
        glosario: [],
        ruta: 'git',
    ...
    },
    {
        ...
        posicion: 'rot-2',
        abertura: '80%',
        rutaIcono: 'assets/img/categorias/typescript-white.png',
        alturaIcono: '40',
        estado: 'activo',
        glosario: [],
        ruta: 'typescript',
