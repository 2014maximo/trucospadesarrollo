...
export const DEVELOPER: DatosPost[] = [
    ...
    },
    {
        ...
        descripcion: [
            'DEVELOPER.dev-super-recursos.descripcion.tx1',
            'DEVELOPER.dev-super-recursos.descripcion.tx2',
            'DEVELOPER.dev-super-recursos.descripcion.tx3',
            'DEVELOPER.dev-super-recursos.descripcion.tx4'
        ],
        descripcionCorta: 'DEVELOPER.dev-super-recursos.descripcionCorta',
        ruta: 'blog/developer/sites',
        componente: 'DevSitesComponent',
        mostrarEnPostHome: true,
        referenciaBusqueda: 'DEVELOPER.dev-super-recursos.referenciaBusqueda',
        estilos: ESTILO_DEVELOPER,
    ...
    },
    {
        ...
        fechaCreacion: '2023-09-18',
        fechaActualizacion: '',
        imgHorizontal: new RefImg('https://plantillas_dev.gitlab.io/assets/img/posts/developer/glosario-terminos.jpg'),
        imgVertical: '',
        imgCuadro: '',
        categoria: 'developer',
        posicion: 'rot-3',
    ...
    },
    {
        ...
        fechaActualizacion: '',
        imgHorizontal: new RefImg('https://plantillas_dev.gitlab.io/assets/img/posts/developer/gallery-extra-money.jpg'),
        imgVertical: '',
        imgCuadro: '',
        categoria: 'developer',
        posicion: 'rot-3',
