...
export const CATEGORIES: CategoriesPageModel[] = [
	...
	{
		iconDark: 'assets/img/categorias/kubernetes.png',
		iconLight: 'assets/img/categorias/kubernetes.png',
		height: '60',
		width: 'auto',
		alt: 'icon-kubernetes',
		class: 'drop box',
		linkCategory: '/blog/kubernetes',
		state: 'inactive',
		nameCategorie: 'kubernetes',
		posicion: 'pos-z',
		colorFondo: 'bg-Kubernetes',
		color: 'text-light'
	},
	{
		iconDark: 'assets/img/categorias/net-framework.png',
		iconLight: 'assets/img/categorias/net-framework.png',
		height: '60',
		width: 'auto',
		alt: 'icon-net',
		class: 'drop box',
		linkCategory: '/blog/net',
		state: 'inactive',
		nameCategorie: 'net',
		posicion: 'rot-2',
		colorFondo: 'bg-Net',
	...
	{
		iconDark: 'assets/img/categorias/php.png',
		iconLight: 'assets/img/categorias/php.png',
		height: '60',
		width: 'auto',
		alt: 'icon-php',
		class: 'drop box',
		linkCategory: '/blog/php',
		state: 'active',
		nameCategorie: 'php',
		posicion: 'rot-2',
		colorFondo: 'bg-Php',
	...
	{
		iconDark: 'assets/img/categorias/react.png',
		iconLight: 'assets/img/categorias/react.png',
		height: '60',
		width: 'auto',
		alt: 'icon-react',
		class: 'drop box',
		linkCategory: '/blog/react',
		state: 'inactive',
		nameCategorie: 'react',
		posicion: 'rot-2',
		colorFondo: 'bg-React',
	...
	{
		iconDark: 'assets/img/categorias/wordpress2.png',
		iconLight: 'assets/img/categorias/wordpress2.png',
		height: '60',
		width: 'auto',
		alt: 'icon-wordpress',
		class: 'drop box',
		linkCategory: '/blog/wordpress',
		state: 'inactive',
		nameCategorie: 'wordpress',
		posicion: 'rot-2',
